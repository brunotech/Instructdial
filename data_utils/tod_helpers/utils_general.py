...
def get_loader(args, mode, tokenizer, datasets, unified_meta, shuffle=False):
    ...
    if args["task_name"] == "rs" or task == "dm": 
    ...
    dataset = globals()[f"Dataset_{task}"](
    ...
    return torch.utils.data.DataLoader(
        ...
        collate_fn=globals()[f'collate_fn_{task}_{args["example_type"]}'],
    )
