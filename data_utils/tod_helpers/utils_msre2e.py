...
def prepare_data_msre2e(args):
    ...
    pair_mov = globals()[f"read_langs_{_example_type}"](
        args, file_mov, max_line, f"{ds_name}-mov"
    )
    pair_rst = globals()[f"read_langs_{_example_type}"](
        args, file_rst, max_line, f"{ds_name}-rst"
    )
    pair_tax = globals()[f"read_langs_{_example_type}"](
        args, file_tax, max_line, f"{ds_name}-tax"
    )
